...
export const BIKE_MAX = 42;
export const BIKE_ACCEL = 30;
export const BIKE_BRAKE = 44;
export const BIKE_TURN = 3.3;
export const BIKE_DRAG = 0.6;
export const BIKE_RADIUS = 0.65;
